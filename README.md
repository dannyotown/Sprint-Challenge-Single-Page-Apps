...
> Answer: Faster navigation throughtout the page. All the components are loaded up front!
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML.
- [ ] What are `controlled components` in React?
> Answer: Where the virtual DOM controls every aspect of the component and not the DOM!
